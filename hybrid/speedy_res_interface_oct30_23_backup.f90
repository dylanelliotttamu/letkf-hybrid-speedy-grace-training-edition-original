module speedy_res_interface
 ...
 subroutine read_model_states(reservoir,grid,model_parameters,start_year,end_year,speedy_data,timestep_arg)
  ...
  subroutine read_letkf_analysis(reservoir,grid,model_parameters,start_year,end_year,era_data,timestep_arg)
     ...
     regrid_file_name =  '/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/speedy_analysis_1981_2012_uniform_covar_1_5_updated.nc' ! '/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/hybrid_1_5_1_3_19810101_20100101_analysis_updated.nc' !'/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/speedy_analysis_1981_2012_uniform_covar_1_5.nc''/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/uniform_analysis_81_12.nc'
  ...
  subroutine read_model_states_letkf(reservoir,grid,model_parameters,start_year,end_year,speedy_data,timestep_arg)
     ...
     restart_file_name = '/scratch/user/dylanelliott/SPEEDY_STATES/speedy_states_from_letkf_speedy_covariance_1_5_speedy_1981_2010_retry.nc' !'/scratch/user/dylanelliott/SPEEDY_STATES/speedy_states_from_hybrid_1_5_1_3_1981_2010.nc' !'/scratch/user/dylanelliott/SPEEDY_STATES/speedy_states_letkf_covariance_1_5_1981_2012.nc' !'/scratch/user/dylanelliott/SPEEDY_STATES/restart_1981_2011_uniform_letkf_analysis.nc'
     print *, 'restart_file_name',restart_file_name
     call read_speedy_data_parallel(restart_file_name,mpi_res,grid,speedy_data,1,1)
     !speedy_data%speedyvariables(:,:,:,:,2:numofhours) = speedy_data%speedyvariables(:,:,:,:,1:numofhours-1)
     !speedy_data%speedy_logp(:,:,2:numofhours) = speedy_data%speedy_logp(:,:,1:numofhours-1)

     speedy_data%speedyvariables(:,:,:,:,2:size(speedy_data%speedyvariables,5)) = speedy_data%speedyvariables(:,:,:,:,1:size(speedy_data%speedyvariables,5)-1)
     speedy_data%speedy_logp(:,:,2:size(speedy_data%speedy_logp,3)) = speedy_data%speedy_logp(:,:,1:size(speedy_data%speedy_logp,3)-1)
     ! These two lines below are the originals
     ! speedy_data%speedyvariables(:,:,:,:,2:numofhours) = speedy_data%speedyvariables(:,:,:,:,1:numofhours-1) 
     ! speedy_data%speedy_logp(:,:,2:numofhours) = speedy_data%speedy_logp(:,:,1:numofhours-1)
