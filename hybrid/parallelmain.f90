program main
  ...
  use mpires, only : mpi_res, startmpi, distribute_prediction_marker, killmpi, predictionmpicontroller, sendrecievegrid, write_truth_data_ensemble
  ...
  !do i=1, 40 
     !call write_truth_data_ensemble(res,res%model_parameters%traininglength - res%model_parameters%synclength*i,i)
  !enddo
  ...
  ! COmment out initialize prediction
