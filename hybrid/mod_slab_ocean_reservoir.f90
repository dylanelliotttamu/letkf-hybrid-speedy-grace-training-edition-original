...
subroutine write_controller_file(model_parameters)
   ...
   file_path = '/scratch/user/dylanelliott/ML_SPEEDY_WEIGHTS/'//trim(model_parameters%trial_name)//'_controller_file.txt'
...
subroutine write_trained_res(reservoir,model_parameters,grid)
  ...
  file_path = '/scratch/user/dylanelliott/ML_SPEEDY_WEIGHTS/'
