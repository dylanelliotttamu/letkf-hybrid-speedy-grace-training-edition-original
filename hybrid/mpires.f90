module mpires
   ...
   contains
     ...
     subroutine predictionmpicontroller(res,timestep)
        ...
        file_path = '/scratch/user/dylanelliott/Predictions/Hybrid/'
     ...
     subroutine sendrecievegrid(res,timestep,ocean_model)
        ...
        if(timestep == 1) then
          ...
          !print *,'timestepdylan ',timestep, 'resdylan',res
          call write_truth_data(res,timestep)
        endif
        ...
        if(mpi_res%is_root) then
           ...
           do i=1, res%model_parameters%num_of_regions_on_proc
              do j=1, res%model_parameters%num_vert_levels
                 ...
                 print *, 'dylan print: ',1,res%reservoir(i,j)%reservoir_numinputs, res%reservoir(i,j)%sst_size_input,res%reservoir(i,j)%tisr_size_input
                
                 print *, 'res%model_parameters%timestep ', res%model_parameters%timestep , 'timestep ', timestep
                 print *, 'res%model_parameters%synclength ', res%model_parameters%synclength 
