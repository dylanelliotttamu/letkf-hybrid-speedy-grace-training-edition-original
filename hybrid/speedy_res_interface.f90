module speedy_res_interface
 ...
 contains 
   subroutine startspeedy(model_parameters,grid,runspeedy)
      ...
      call initialize_calendar(calendar,2011,1,1,0)!call initialize_calendar(calendar,1982,1,1,0)
  ...
  subroutine read_era(reservoir,grid,model_parameters,start_year,end_year,era_data,timestep_arg)
     ...
     do year_i=start_year,end_year
         ...
         print *, 'calling read_era_data_parallel'
 ...
 subroutine read_model_states(reservoir,grid,model_parameters,start_year,end_year,speedy_data,timestep_arg)
  ...
  subroutine read_letkf_analysis(reservoir,grid,model_parameters,start_year,end_year,era_data,timestep_arg)
     ...
     ! this is the letkf analysis file
     regrid_file_name = '/scratch/user/dylanelliott/letkf-hybrid-speedy-from-skynet-2/DATA/uniform_letkf_analysis/ERA5_hybrid_1_9_20110101_20120101/mean_output/out_updated.nc'!'/scratch/user/dylanelliott/backup_letkf_data_from_skynet/uniform_letkf_anal/hybrid_1_9_1_9_mem_1_fixed_20110101_20120115/out_updated.nc'
     !regrid_file_name = '/scratch/user/dylanelliott/letkf-hybrid-speedy-grace-training-edition-original/DATA/era5_letkf_uniform_1981_2012/hybrid_1_9_1_9_19810101_20100101_updated.nc'!'/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/speedy_1_9_19810101_20100101_4_15_24_updated.nc'!'/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/speedy_analysis_1981_2012_uniform_covar_1_5_updated.nc' !'/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/speedy_analysis_1981_2012_uniform_covar_1_5.nc''/scratch/user/dylanelliott/letkf-hybrid-speedy/DATA/era5_letkf_uniform_1981_2012/uniform_analysis_81_12.nc'
  ...
  subroutine read_model_states_letkf(reservoir,grid,model_parameters,start_year,end_year,speedy_data,timestep_arg)
     ...
     restart_file_name = '/scratch/user/dylanelliott/SPEEDY_STATES/speedy_states_from_ERA5_hybrid_1_9_20110101_20120101.nc' !'/scratch/user/dylanelliott/SPEEDY_STATES/speedy_states_from_hybrid_1_9_1_9_20110101_20120101_try_again_11_27_24.nc' !'speedy_states_from_hybrid_1_9_1_9_19810101_20100101.nc'!'/scratch/user/dylanelliott/SPEEDY_STATES/speedy_states_from_speedy_1_9_19810101_20100101.nc' !'/scratch/user/dylanelliott/SPEEDY_STATES/speedy_states_letkf_covariance_1_5_1981_2012.nc' !'/scratch/user/dylanelliott/SPEEDY_STATES/restart_1981_2011_uniform_letkf_analysis.nc'
     print *, 'restart_file_name',restart_file_name
